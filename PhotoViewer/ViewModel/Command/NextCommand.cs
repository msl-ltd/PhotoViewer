//-----------------------------------------------------------------------
// <copyright file="NextCommand.cs" company="MSL Ltd.">
//     (C) 2018 MSL Ltd.
// </copyright>
...
namespace PhotoViewer.ViewModel.Command
{
    ...
    /// 次へコマンドを定義します。
    /// </summary>
    internal class NextCommand : CommandBase<MainViewModel>
    {
        /// <summary>
        ...
        /// コマンドにデータを渡す必要がない場合は、このオブジェクトを null に設定できます。
        /// </param>
        protected override void Execute(MainViewModel parameter) => parameter?.Next();
    }
}
